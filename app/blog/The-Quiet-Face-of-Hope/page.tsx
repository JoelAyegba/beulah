          ...
          <div className="max-w-3xl mx-auto">
            ...
            <article className="prose prose-lg max-w-none mb-8 blog-font">
              <p style={{ textIndent: '1.5em' }}>
                ...
                clutching the last thread of belief it has left. We’ve seen her, hope, that is, in all her disguises. She
                doesn’t always look like what people imagine. She doesn’t come with trumpets or hashtags or dramatic
              ...
              <p style={{ textIndent: '1.5em' }}>
                ...
                then breaking into a smile when she realizes no one is judging her. Just women, like her, sharing stories
                and seeing what no one else does. Hope also looks like the woman in a support group for infertility and
                finally says out loud, “I am tired, but I am not giving up.” Her voice would crack, everyone would cry with
                her, then someone would pass her a tissue.
              </p>

              <h2 className="pl-6 font-semibold">Hope Is Messy (And Beautiful)</h2>
              <p style={{ textIndent: '1.5em' }}>
                We like to think hope is neat, that it ties its shoelaces and wears matching socks. But no, hope is messy.
                She forgets where she kept her courage sometimes. She doubts herself. She prays, cries, and still goes
                again tomorrow.
              </p>

              <p style={{ textIndent: '1.5em' }}>
                At Beulah Walk of Hope, we have learned to stop romanticizing hope. It’s not always pretty. It’s not always
                loud. Sometimes it’s just someone choosing to breathe; one more day, one more chance. And that’s okay.
                Because hope doesn’t need a spotlight; it just needs space. Space to wobble, space to rest, space to rise
                again.
              </p>
              ...
              <p style={{ textIndent: '1.5em' }}>
                And sometimes, hope feels like letters. We have received a few handwritten notes from women we have
                met, saying things like,
              </p>
              ...
              <p style={{ textIndent: '1.5em' }}>
                That is why we call it Beulah Walk of Hope, because hope doesn’t sit still; it moves. She walks beside women
                through long nights, through the waiting, through it all.
              </p>
              ...
              <p style={{ textIndent: '1.5em' }}>
                If this moved you, it is because hope is contagious; it finds light and shares it. You can be part of that
                light. Walk with us. Sponsor a project. Volunteer your hands. Lend your voice. Share our stories. Every
                act of kindness helps another woman stand taller, another girl dream wider. Join Beulah Walk of Hope.
              </p>
            </article>
