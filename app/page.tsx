        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/10 mb-4">
              ...
              <span className="text-sm font-medium text-secondary">Join Us</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold font-[family-name:var(--font-playfair)] mb-4">Upcoming Events</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              {"Connect, learn, and grow with our community through workshops, conferences, and outreach programs."}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              <div className="relative h-48">
                <img
                  src="/outreach-1.jpg"
                  alt="Feed 1000 Families in Nigeria"
                  className="w-full h-full object-cover"
                />
                <Badge className="absolute top-4 left-4 bg-secondary">Outreach</Badge>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-2 mb-4 text-sm text-muted-foreground">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>Beulah walk of hope foundation Training Center, Abuja, Nigeria</span>
                  </div>
                </div>
                <p className="text-muted-foreground leading-relaxed mb-4">
